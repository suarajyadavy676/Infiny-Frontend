...
function Body() {
  ...
  return (
    <div>
      ...
      <div>
        <h1 className="text-center text-2xl lg:text-4xl my-4">It’s not a pipeline problem.</h1>
        <h1 className="text-center text-2xl lg:text-4xl text-green-500 my-4">It’s a spotlight problem.</h1>
        <p className="lg:w-[60%] mx-auto text-center text-lg w-[90%]">Tech hiring needs a reset. From prepping for jobs and practicing coding to running a world-class technical interview, give developers the tools they need to showcase their skills, passion, and potential.</p>
      </div>
    </div>
  );
}
